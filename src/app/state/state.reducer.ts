...
export const initialState: ObjectState = getState();

export const objectReducer = createReducer(
  initialState,
  on(addObject, (state, { bot }) => ({ ...state, bots: [...state.bots, bot] })),
);

function getState(): ObjectState {
