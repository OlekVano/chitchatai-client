    ...
    return [
      {
        ...
        name: 'Sarah',
        status: 'Camping in the mountains',
      ...
      },
      {
        ...
        name: 'John',
        status: 'Searching StackOverflow',
